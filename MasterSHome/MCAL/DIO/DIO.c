...
void MDIO_toggle(u8 portname,u8 pinnumber)
{
	switch(portname)
	{
		case PORTA:
			TOGGLE_BIT(DIO_PORTA_REG,pinnumber);//Toggle the value of the given pin in port A
		break;
		case PORTB:
			TOGGLE_BIT(DIO_PORTB_REG,pinnumber);//Toggle the value of the given pin in port B
		break;
		case PORTC:
			TOGGLE_BIT(DIO_PORTC_REG,pinnumber);//Toggle the value of the given pin in port C
		break;
		case PORTD:
			TOGGLE_BIT(DIO_PORTD_REG,pinnumber);//Toggle the value of the given pin in port D
		break;
		default: break;
	}
}
